...
export function SkeletonFacilitator() {
  return (
    <>
...
interface SkeletonFormFieldsFacilitatorProps {
  readOnly?: boolean
}

export default function SkeletonFormFieldsFacilitator({
  readOnly,
}: SkeletonFormFieldsFacilitatorProps) {
  return (
    <>
      <FormFieldsGroup>
        <FormField>
