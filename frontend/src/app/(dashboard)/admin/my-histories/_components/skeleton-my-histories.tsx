...
export function SkeletonMyHistories() {
  return (
    <>
...
interface SkeletonFormFieldsMyHistoryProps {
  readOnly?: boolean
}

export default function SkeletonFormFieldsMyHistory({
  readOnly,
}: SkeletonFormFieldsMyHistoryProps) {
  return (
    <>
      <FormFieldsGroup>
        <FormField>
